'use client';
import { Container, Typography, Box, Divider, Paper, List, ListItem, ListItemText, Snackbar, IconButton } from '@mui/material';
    ...
    <List sx={{ listStyleType: 'disc', pl: 4, mb: 2 }}>
        {items.map((item, index) => (
            <ListItem key={index} sx={{ display: 'list-item', p: 0, mb: 1 }}>
                <ListItemText primary={item} sx={{ '& .MuiListItemText-primary': { fontSize: '1.1rem', lineHeight: 1.7, color: 'text.primary' } }} />
            </ListItem>
        ))}
    </List>
);
    ...
    return (
        <Container component="main" maxWidth="md" sx={{ mt: 8, mb: 8 }}>
            <article>
                ...
                <AnimateOnScroll delay={0.7}>
                    <PostImage src="/BlogImg3.png" alt="A graph showing a decrease in customer support tickets and an increase in customer satisfaction after implementing proactive AI." />
                </AnimateOnScroll>
